...
| **Буквы → приём на слух** | **+1 XP** за верный ответ (**+2 XP** за кириллицу) | Спам верной плиткой в паузе между раундами заблокирован. Кириллица даёт небольшой бонус «для разнообразия» (решение владельца, v2.51.1) — не формула сложности, а простой множитель. |
