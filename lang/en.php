...
return [
    ...
    'groups.buffer_listening_lag' => '🎧 Listen with a {n}-char lag…',
    ...
    'groups.buffer_tip_lag' => 'Listen with a {n}-char lag: input unlocks after {n} character(s). Type heard characters lagging behind the audio — this trains your short-term buffer.',
