...
return [
    ...
    // --- includes/footer.php ---
    'footer.version_title' => 'MorseWave version and last update date',
    ...
    'index.invasion_badge_stages' => '3 stages · 3 bosses',
    'index.invasion_title' => 'Invasion — Morse code arcade',
    'index.invasion_text' => 'Aliens attack in waves: single ships, pairs and triplets in formation, and a unique boss at each stage finale.',
    'index.invasion_highlight' => 'Bugs fixed and physics rebalanced — test your skills!',
    'index.invasion_enemy_role' => 'Target',
    'index.invasion_enemy_name' => 'Invader',
    'index.invasion_weapon_role' => 'Weapon',
    'index.invasion_weapon_name' => 'Combat Shovel',
    'index.invasion_weapon_footer' => 'Base weapon: Tactical Shovel',
    ...
    'learn.intro' => 'Four modes: <b>sending</b> — tap out symbols with a key; <b>ear training</b> — type the letter you hear; <b>key rhythm</b> — practice your timing; and <b>Invasion</b> — an arcade survival mini-game. Select a sub-mode above!',
    ...
    'learn.invasion_intro' => 'Aliens are advancing on your base — listen to the signal, identify the letter, and press it before the alien reaches the base. The game consists of 3 stages: 1) single targets + Boss 1 (10 characters); 2) groups of 2 characters + Boss 2 (20 characters); 3) groups of 3 characters + Final Boss (Latin quote). Build combos to activate abilities (Repair, Slow, Nuke)! Defeating the 3rd boss saves the base with a huge bonus.',
    'learn.invasion_start' => 'Engage',
    'learn.invasion_stop' => 'Stop',
    'learn.invasion_base_hp' => 'Base HP',
    'learn.invasion_pu_hint' => 'Build combos to activate power-ups:',
    'learn.invasion_pu_repair' => 'Repair',
    'learn.invasion_pu_slow' => 'Freeze',
    'learn.invasion_pu_nuke' => '1kW Amp ON',
    'learn.invasion_pu_repair_msg' => '💖 Base repaired (+10 HP)',
    'learn.invasion_pu_slow_msg' => '⏱️ TIME FROZEN (6 sec)',
    'learn.invasion_pu_nuke_msg' => '💥 EMP BLAST',
    'learn.invasion_boss_killed_mid' => 'Intermediate Boss destroyed!',
    'learn.invasion_result_title_win' => '🎉 Wave Successfully Defended!',
    'learn.invasion_result_title_lose' => '💥 Base Destroyed',
    'learn.invasion_badge_win' => 'VICTORY',
    'learn.invasion_badge_lose' => 'DEFEAT',
    'learn.invasion_stat_accuracy' => 'Accuracy',
    'learn.invasion_stat_kills' => 'Enemies Killed',
    'learn.invasion_stat_xp' => 'XP Earned',
    'learn.invasion_breakdown_label' => 'XP CALCULATION BREAKDOWN',
    'learn.invasion_restart_btn' => 'Battle Again',
    'learn.invasion_quote_intercept' => 'Radio Intercept',
    ...
    'groups.mode_training' => '🏋️ Training',
    'groups.mode_pairs' => '🥊 Confused Pairs',
    'groups.mode_qrq' => '🚀 QRQ Warmup',
    'groups.mode_exam' => '🎓 Exam',
    'groups.buffer_input' => 'Delayed input (Buffer)',
    'groups.buffer_tooltip' => 'With delayed input, the input field is locked while the group plays (for 2, 3, 4, or 5 characters). Listen to the full group and type it from memory — this trains your short-term buffer and stops rushed typing during micro-pauses.',
    'groups.buffer_listening' => '🎧 Listen to the full group…',
    'groups.buffer_listening_all' => '🎧 Listen to the full group…',
    ...
    'groups.pairs_custom_placeholder' => 'e.g. S H',
    'groups.pairs_stage_label' => 'Training stage:',
    'groups.pairs_stage_1' => 'Stage 1: Isolate {A}',
    'groups.pairs_stage_1_desc' => 'Letter {B} is completely disabled. All dot/dash patterns are strictly {A}. Don\'t hesitate!',
    'groups.pairs_stage_2' => 'Stage 2: Isolate {B}',
    'groups.pairs_stage_2_desc' => 'Letter {A} is completely disabled. All similar patterns are strictly {B}.',
    'groups.pairs_stage_3' => 'Stage 3: Duel {A} vs {B}',
    'groups.pairs_stage_3_desc' => 'Both characters are mixed in with high frequency. Test confident discrimination under pressure.',
    'groups.pairs_banner_disabled' => '🛡️ Character {DISABLED} is COMPLETELY DISABLED! All similar patterns are strictly {ACTIVE}. Have no doubt!',
    'groups.pairs_disabled_alert' => '⚠️ Character {DISABLED} is not in this exercise! All such characters are strictly {ACTIVE}.',
    'groups.pairs_accuracy_pair' => 'Accuracy on pair {PAIR}:',
    'groups.pairs_next_stage' => '▶ Proceed to next stage (Stage {next})',
    'groups.pairs_repeat_stage' => '🔁 Retry this stage',
    'groups.pairs_finish_course' => '✅ Pair training course completed!',
    'groups.qrq_title' => 'QRQ Warmup (Speed Plateau Buster)',
    'groups.qrq_intro' => 'A fast warmup set: 10 groups at boosted speed. No typing needed — put on headphones, relax, and catch the overall melody of characters without counting dits. After this warmup, regular training will feel noticeably slower!',
    'groups.qrq_speed_label' => 'Warmup speed:',
    'groups.qrq_speed_diff' => '(your current {base} wpm + 6 wpm)',
    'groups.qrq_start' => '🚀 Start warmup set',
    'groups.qrq_listening_group' => 'Warmup set',
    'groups.qrq_hint_1' => '🎧 Relax. Do not count dits and dahs — listen for the unified melody of the character.',
    'groups.qrq_hint_2' => '💡 Don\'t worry if you miss some — your subconscious is training in the background.',
    'groups.qrq_hint_3' => '⚡ After this warmup, head back to regular training — your normal speed will feel remarkably easy!',
    'groups.qrq_finished_title' => '🎉 Warmup set completed!',
    'groups.qrq_finished_desc' => 'Ears primed, plateau broken! Return to your normal training — the speed will feel comfortable and slow.',
    'groups.chars_short' => 'chars',
    'groups.buffer_depth_label' => 'Buffer lag:',
    'groups.buffer_depth_desc' => 'The field unlocks only after the specified number of characters have sounded (training delay lag), or after the full group.',
    'groups.buffer_depth_all' => 'Full group',
    'groups.pairs_smart_active_title' => 'Smart Mistake Analyzer',
    'groups.pairs_smart_active_desc' => 'The system automatically tracks characters you confuse during training and exams. Once enough mistake stats are gathered, a personal recommendation for your problem pair will appear right here!',
    'groups.pairs_custom_enter_title' => 'Enter 2 characters for your pair:',
    'groups.pairs_custom_hint' => 'Any 2 letters or digits (e.g. S and H)',
    'groups.method_tips_btn' => '💡 CW Methodology & Tips',
    'groups.method_tips_title' => 'Practical Guidelines from Experienced Operators',
    'groups.tip_1_title' => '1. Mnemonics vs Sound Melody',
    'groups.tip_1_text' => 'At the beginner stage, mnemonics help memorize character codes. However, as speed increases, verbal mnemonics and counting dits in your head become a bottleneck. Above 15–18 WPM, a character must be perceived as a single musical chord or rhythmic pattern. This is why you should practice copying behind (Delayed Input buffer mode) — it trains your brain not to jerk your fingers during micro-pauses, but to hold 2–3 characters in your mental short-term buffer and type them calmly.',
    'groups.tip_2_title' => '2. Short-Term Memory Buffer',
    'groups.tip_2_text' => 'A common beginner mistake is rushing to press a key during micro-pauses between characters. Above 20 WPM, the brain cannot react in "hear-and-press" mode. Practice copying behind by 1–2 characters (holding them in short-term buffer) or delaying input until the entire group finishes.',
    'groups.tip_3_title' => '3. Isolation Method for Confused Pairs',
    'groups.tip_3_text' => 'If you frequently confuse similar characters (e.g., S/H, B/D, U/V), do not keep copying them together in the same stream — that only reinforces panic. Remove one character of the pair from the exercise for 1–2 sessions: your brain eliminates doubt and builds confident reflex.',
    'groups.tip_4_title' => '4. The 90% Rule & Short Sessions',
    'groups.tip_4_text' => 'Only increase speed when you consistently score at least 90% accuracy. Train in short bursts: 2–3 sessions of 15–20 minutes daily yield far better progress than a single exhausting hour-long session that fatigues your ears.',
    'groups.exam_hint' => 'Exam mode: 50 groups of 5 characters (letters + digits), 250 characters total, 550 Hz tone. Timing matches a real exam: letters sound crisp and fast (20 wpm element speed), while the stretched pauses between groups bring the effective pace down to ≈60 characters/min. Groups play one after another without waiting for your answer — endurance training.<br><br>💡 <b>How to answer:</b> Type the copied groups here, making sure to separate them with a space or Enter. If you prefer to copy onto paper instead — just leave the field blank (or type your text from the sheet afterwards, the system will wait for you!) and click "Check" when finished, the system will output the correct text for you to verify.',
    ...
    'groups.check' => 'Check →',
    'groups.exam_placeholder' => 'Separate groups with spaces/Enter, or leave blank to check against paper…',
    ...
    'groups.daily_time_progress' => '⏱ Trained today: {done} min. {left} min left to reach your daily goal ({goal} min).',
    'groups.daily_time_done' => '🎉 Great job! You trained {done} min today — daily goal ({goal} min) completed!',
    'groups.daily_time_change_hint' => '(you can adjust your goal in <a href="account.php?tab=display" class="link">profile</a>)',
    ...
    'cs.buffer_listening_all' => '🎧 Listen to the full callsign…',
    'cs.buffer_depth_all' => 'Full callsign',
    ...
    'acc.daily_goal_title' => 'Daily training goal',
    'acc.daily_goal_desc' => 'How many minutes per day you plan to practice Morse code. Your progress is displayed at the end of each session.',
    'acc.mins' => 'min',
...
HTML,
    ...
    'js.learn.invasion_stage1' => 'Stage 1: Single targets',
    'js.learn.invasion_stage2' => 'Stage 2: Groups of 2 characters',
    'js.learn.invasion_stage3' => 'Stage 3: Groups of 3 characters',
    ...
    'js.learn.invasion_boss_incoming' => '🛸 A boss saucer approaches!',
    'js.learn.invasion_boss1_incoming' => '🛸 Boss 1: copy 10 characters in a row!',
    'js.learn.invasion_boss2_incoming' => '🛸 Boss 2: copy 20 characters in a row!',
    'js.learn.invasion_boss3_incoming' => '🛸 FINAL MEGA-BOSS: copy the Latin quote!',
    'js.learn.invasion_boss_hit' => 'Boss hit! ({hits}/{total})',
    'js.learn.invasion_boss_kill' => 'Boss destroyed!',
    'js.learn.invasion_boss1_kill' => 'Boss 1 destroyed! Advancing to Stage 2.',
    'js.learn.invasion_boss2_kill' => 'Boss 2 destroyed! Advancing to Stage 3.',
    'js.learn.invasion_boss3_kill' => 'Mega-Boss defeated! Earth is saved, game beaten!',
    'js.learn.invasion_boss_breach' => 'The boss broke through! Base lost {dmg} HP.',
    'js.learn.invasion_xp_ships' => '{xp} (ships)',
    'js.learn.invasion_xp_bosses' => '{xp} (bosses)',
    'js.learn.invasion_xp_hp' => '{xp} (base HP)',
    'js.learn.invasion_xp_speed' => '{xp} (speed)',
    'js.learn.invasion_xp_daily' => '{xp} (daily challenge)',
    'js.learn.invasion_xp_first_win' => '{xp} (first win)',
    'js.learn.invasion_first_win_title' => 'Daily First Win in Invasion',
    'js.learn.invasion_first_win_desc' => 'Defend the base from aliens and earn +50 XP daily bonus.',
    'js.learn.invasion_first_win_done' => '🌟 Daily first win in Invasion: +50 XP awarded!',
    'js.learn.invasion_first_win_already' => '✓ Daily first win bonus in Invasion already claimed today',
    'js.learn.invasion_daily_win' => '🎉 Daily Challenge completed: +50 XP awarded!',
    'js.learn.invasion_daily_already' => 'ℹ️ Daily challenge already completed today',
    'js.learn.invasion_daily_lose' => '⚠️ Daily Challenge: defeat all 3 bosses and save the base to earn bonus',
    ...
    'js.learn.rec_press_start' => 'Press "Start training" (or Enter/Space) to begin copy.',
    'js.learn.wrong_layout' => 'Please switch your keyboard layout to English',
    ...
    'js.koch.wrong' => 'Expected:&nbsp;{expected}<br>You typed: {typed}',
    ...
    'js.koch.stopped_early' => 'Session stopped early ({played}/{total} groups). XP awarded for completed characters.',
    ...
    'js.groups.wrong' => 'Expected:&nbsp;{expected}<br>You typed: {typed}',
    'js.groups.empty_placeholder' => '(empty)',
    'js.groups.pairs_stage_done' => 'Stage {stage} completed! Target pair accuracy: {acc}%',
    'js.groups.qrq_group_label' => 'Group {current} of {total}',
    'js.groups.qrq_active_listening' => '🎧 Playing… Listen',
    'js.groups.retrain_intro' => 'Reviewing {count} group(s) that had mistakes — take your time.',
    'js.groups.exam_configured' => 'Exam mode is set up: 50 groups of 5 characters, 250 characters, 550 Hz tone. Letters play at 20 wpm, with pauses between groups stretched so the effective pace is ≈60 characters/min — like a real exam. Groups play one after another without waiting for an answer. Press "Start session".',
    ...
    'js.groups.exam_stopped_early' => 'Exam stopped early (played {played}/{total} groups). You were awarded basic 1x XP for correct characters, and the result is honestly counted toward your overall group total.',
    'js.groups.stopped_early' => 'Training stopped early ({played}/{total} groups). XP awarded for completed characters.',
    'js.groups.exam_passed_category' => 'Exam passed! Errors: {wrong} (limit: 3).',
    'js.groups.exam_passed_toomany' => 'Exam failed. Errors: {wrong} (allowed up to 3). Keep practicing!',
    'js.groups.exam_paper_mode' => 'Exam finished. You copied onto paper — check your sheet against the correct text below.',
    'js.groups.exam_diff_paper' => 'Exam text (paper copy):',
    'js.groups.exam_diff_report' => 'Detailed report (Expected / Typed):',
    ...
    'js.daily.groups_desc' => 'Copy groups in "Symbol Groups" mode. +50 XP bonus once a day.',
    'js.daily.callsigns_title' => '{count} callsigns at {wpm} wpm',
    'js.daily.callsigns_desc' => 'Copy callsigns in "Callsigns" mode. +50 XP bonus once a day.',
    'js.daily.koch_title' => 'Complete a Koch method session',
    'js.daily.koch_desc' => 'Finish one session in "Koch Method" mode. +50 XP bonus once a day.',
    'js.daily.invasion_title' => 'Repel an Invasion wave',
    'js.daily.invasion_desc' => 'Defend the base from aliens in "Learn → Invasion" mode. +50 XP bonus once a day.',
    ...
    'donate.sbp_title' => 'Direct transfer via SBP (Zero fee)',
    'donate.sbp_desc' => 'Fast and zero-fee transfer from any mobile banking app in Russia',
    'donate.sbp_recipient' => 'Recipient',
    'donate.sbp_bank' => 'Bank',
    'donate.sbp_open_app' => '📲 Open in banking app',
    'donate.sbp_copy_link' => '📋 Copy payment link',
    'donate.sbp_copied' => 'Link copied!',
    'donate.sbp_note' => 'When making the transfer, please include your callsign or username in the message if possible (e.g. R9OGL)',
    'donate.cards_title' => 'Appreciation Tiers (Ham Radio Spirit)',
    'donate.tier1_title' => 'Cup of coffee for R9OGL ☕',
    'donate.tier1_desc' => 'Energizes our programmer, boosts Morse copy and coding cool new features, keeping watch day and night so the server never drops!',
    'donate.tier2_title' => 'Handful of crystals and diodes ⚡',
    'donate.tier2_desc' => 'For rock-solid VFO stability and filtering out ether noise.',
    'donate.tier3_title' => 'PA Output Transistor 📻',
    'donate.tier3_desc' => 'So MorseWave signals punch through heavy QRM on long DX paths.',
    'donate.tier4_title' => 'Coil of copper wire and toroids 📡',
    'donate.tier4_desc' => 'For resonant antennas, RF transformers and matching baluns.',
    'donate.tier5_title' => 'Warm tube kilowatt 💡',
    'donate.tier5_desc' => 'Serious boost to server capacities and development of new modes.',
    'donate.tier0_title' => 'Warm CQ and good vibes 💌',
    'donate.tier0_desc' => 'Free support with warm words (0 ₽). Available to everyone and immediately unlocks an achievement!',
    'donate.tier_custom_title' => 'Custom amount 🎁',
    'donate.tier_custom_desc' => 'Any comfortable contribution towards the project via QR or SBP link.',
    'donate.critique_humor' => 'P.S. Constructive critique is accepted on a paid basis only! 😉 73 & TNX FER UR SUPPORT!',
    'donate.form_title' => 'Report support / Say thank you',
    'donate.form_callsign' => 'Your callsign or username',
    'donate.form_amount' => 'Transfer amount (₽)',
    'donate.form_message' => 'Kind words to the author / wish for the project',
    'donate.form_anonymous' => 'Hide my name on the Wall of Recognition (anonymous)',
    'donate.form_submit' => 'Transmit to airwaves 📡',
    'donate.submit_success' => 'Thank you so much for your support! Your contribution matters. 73!',
    'donate.wall_title' => 'Wall of Recognition for MorseWave supporters and friends',
    'donate.wall_intro' => 'Heartfelt gratitude to all radio amateurs and future telegraphers supporting the project in word and deed!',
    'donate.wall_anonymous' => 'Anonymous operator',
    'donate.wall_empty' => 'No messages published here yet. Be the first!',
    'donate.other_methods_title' => 'Other methods (International cards / Alternatives)',
    'donate.other_methods_desc' => 'If you are outside Russia or prefer another payment method (DonationAlerts / Boosty / Crypto) — contact us via the form above or email morse@r9old.ru.',

    // --- VIP Chat & Profile ---
    'account.sponsor_badge' => 'MorseWave Supporter',
    'account.sponsor_promo_title' => 'Supporter badge in leaderboard & private direct chat',
    'account.sponsor_promo_desc' => 'A standout badge of your choice (👑, 💖, ⚡, 📻, ⭐, ✨ or no icon) to highlight your support, plus private chat line with the developer (R9OGL).',
    'account.badge_picker_eyebrow' => 'SUPPORTER BADGE · CHOOSE ICON',
    'account.badge_picker_title' => 'Your icon in the leaderboard',
    'account.badge_picker_desc' => 'Choose the badge displayed next to your callsign in the leaderboard to highlight your project support. You can also choose "No badge" to keep it discreet.',
    'account.badge_saved' => 'Badge saved successfully!',
    'account.badge_error' => 'Failed to save badge',
    'account.chat_title' => 'Direct channel to developer (R9OGL)',
    'account.chat_desc' => 'Private communication line for project supporters. Ask questions, suggest features, and share your feedback directly!',
    'account.chat_placeholder' => 'Write a message to the developer…',
    'account.chat_send' => 'Send',
    'chat.empty_message' => 'Message cannot be empty',

    // --- Admin Tabs & Moderation ---
    'admin.tab_users' => '👥 Users',
    'admin.tab_donations' => '💖 Donations & Wall',
    'admin.tab_chat' => '💬 Support Chat',
    'admin.donations.title' => 'Manage donations and messages',
    'admin.donations.status_pending' => 'Pending review',
    'admin.donations.status_approved' => 'Approved (on wall)',
    'admin.donations.status_rejected' => 'Rejected',
    'admin.donations.approve_btn' => '✅ To Wall',
    'admin.donations.reject_btn' => '❌ Hide',
    'admin.donations.delete_btn' => 'Delete',
    'admin.donations.delete_confirm' => 'Delete this message permanently?',
    'admin.donations.make_sponsor_btn' => '👑 Make Sponsor',
    'admin.donations.remove_sponsor_btn' => 'Remove Sponsor',
    'admin.donations.no_linked_user' => 'No website user linked to this donation',
    'admin.chat.threads_title' => 'Supporter Dialogs',
    'admin.chat.no_threads' => 'No active dialogs',
    'admin.chat.type_reply' => 'Type a reply to user…',
    'admin.chat.send_reply' => 'Reply',
    'js.admin.make_sponsor_btn' => '👑 Make sponsor',
    'js.admin.remove_sponsor_btn' => 'Remove sponsor',

    // --- Achievement ---
    'ach_def.project_supporter.title' => 'Friend of MorseWave',
    'ach_def.project_supporter.desc' => 'Supported project development with kind words or a donation! 73!',
];
