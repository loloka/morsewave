...
return [
    ...
    'groups.exam_hint' => 'Exam mode: 50 groups of 5 characters (letters + digits), 250 characters total, 550 Hz tone. Timing matches a real exam: letters sound crisp and fast (20 wpm element speed), while the stretched pauses between groups bring the effective pace down to ≈60 characters/min. Groups play one after another without waiting for your answer — endurance training.<br><br>💡 <b>How to answer:</b> Type the copied groups here, making sure to separate them with a space or Enter. If you prefer to copy onto paper instead — just leave the field blank and click "Check" when finished, the system will output the correct text for you to verify.',
