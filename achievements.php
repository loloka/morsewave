...
<h1>Достижения</h1>
<p>Каждая пройденная веха на пути от первого сигнала до уверенного приёма —
    учи буквы, держи серию дней, набирай скорость. Новые достижения будут
    появляться по мере развития тренажёра.</p>
