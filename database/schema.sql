...
('cyrillic_alphabet', 'Кириллический алфавит', 'Изучите все буквы кириллической азбуки Морзе', '🇷🇺', 'cyrillic_learned_count', 31, 21),
('cyrillic_recognized', 'Кириллица на слух', 'Опознайте на слух каждую букву кириллической азбуки Морзе хотя бы раз', '🎧', 'cyrillic_recognized_count', 31, 22),
...
CREATE TABLE IF NOT EXISTS users (
    ...
    sponsor_badge          VARCHAR(32) NOT NULL DEFAULT 'crown',
...
-- Полная синхронизация прогресса между устройствами (migration_10).
-- Весь Progress-объект из localStorage как JSON-блоб — приватное личное
-- хранилище, НЕ публичная витрина (для витрины — user_stats выше).
